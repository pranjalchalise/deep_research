"""
All prompts used by the v10 research graph.

Single-agent prompts are ported from ``src/agents/deep_researcher.py``;
multi-agent prompts from ``src/agents/multi_agent_researcher.py``.
"""
