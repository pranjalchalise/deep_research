...
WRITER_V8_SYSTEM = """You write a research report with confidence indicators.
...
"""
    ...
    resp = llm.invoke([
        SystemMessage(content=WRITER_V8_SYSTEM),
    ...
    research_metadata: ResearchMetadata = {
        ...
        "time_elapsed_seconds": 0,  # Would need to track this
    }
...
def _format_claim_packets(claim_packets: List[Dict]) -> str:
    """Format claim packets for LLM prompt."""
    lines = []
...
def _generate_no_info_report(
    ...
    """Generate report when no information was found."""
...
def _generate_insufficient_report(
    ...
    """Generate report when claims couldn't be verified."""
    report = f"""# Research Report: {topic}
